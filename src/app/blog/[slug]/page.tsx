...
const posts = [
  {
    ...
    description:
      "Exploring the impact of artificial intelligence on frontend and backend workflows.",
    tag: "AI & Dev",
  ...
  },
  {
    ...
    description:
      "These modern UI/UX techniques will make your websites look slick on any device.",
    tag: "UI/UX",
    image: "https://placehold.co/600x400",
