...
export const metadata: Metadata = {
  ...
  description:
    "Explore insights, tutorials, and updates from StackNova on web development, AI, app development, and cloud solutions.",
  keywords: [
    "blog",
    "tech blog",
    "web development",
...
const posts = [
  {
    ...
    description:
      "Explore how to build fast and scalable applications using the latest features of Next.js 15, focusing on performance and maintainability.",
  ...
  },
  {
    ...
    description:
      "Deep dive into the power of React Server Components and how they change the way we think about rendering and data fetching.",
  ...
  },
  {
    ...
    description:
      "Discover how AI-powered tools and workflows are revolutionizing business operations and unlocking unprecedented growth opportunities.",
  ...
  },
  {
    ...
    description:
      "A comprehensive guide to building reliable and scalable cloud infrastructure tailored to your specific business needs.",
